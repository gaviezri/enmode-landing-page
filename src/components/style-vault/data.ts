...
export const VAULT_ITEMS: VaultItem[] = [
  ...
  { id: 2,  name: 'Silk Midi Dress',     brand: 'The Row',        price: 1850,                      colorA: '#E8E2D8', colorB: '#C8C2B8', category: 'Dress',                          board: 'Evening Aesthetics' },
  ...
  { id: 5,  name: 'Loafers',             brand: 'Bottega Veneta', price: 980,                       colorA: '#C4956A', colorB: '#A47550', category: 'Shoes',                          board: 'Everyday Luxury'    },
  { id: 6,  name: 'Mini Shoulder Bag',   brand: 'Saint Laurent',  price: 1250,                      colorA: '#1A1614', colorB: '#100E0C', category: 'Accessory',                      board: 'Evening Aesthetics' },
  { id: 7,  name: 'Ribbed Turtleneck',   brand: 'Arket',          price: 89,                        colorA: '#F0EBE2', colorB: '#D5CEC5', category: 'Top',                            board: 'Everyday Luxury'    },
...
export const BOARDS = ['All', 'Autumn Workwear', 'Evening Aesthetics', 'Everyday Luxury'] as const
